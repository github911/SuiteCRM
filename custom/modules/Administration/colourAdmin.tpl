...
<form id="ConfigureSettings" name="ConfigureSettings" enctype='multipart/form-data' method="POST"
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr style="float:left;">
            <td>{$MOD.LBL_COLOUR_ADMIN_BASE}</td><td><input type="text" id="colourselector_navbar" name="colourselector_navbar" class="color" value="{$config.colourselector.navbar}" size="15" /></td>
        </tr>
        <tr style="float:left;">
            <td>{$MOD.LBL_COLOUR_ADMIN_MENUHOVER}</td><td><input type="text" id="colourselector_navbarlihover" name="colourselector_navbarlihover" class="color" value="{$config.colourselector.navbarlihover}" size="15" /></td>
            <td>{$MOD.LBL_COLOUR_ADMIN_DDLINK}</td><td><input type="text" id="colourselector_dropdownmenulink" name="colourselector_dropdownmenulink" class="color" value="{$config.colourselector.dropdownmenulink}" size="15" /></td>
            <td>{$MOD.LBL_COLOUR_ADMIN_DDMENU}</td><td><input type="text" id="colourselector_dropdownmenu" name="colourselector_dropdownmenu" class="color" value="{$config.colourselector.dropdownmenu}" size="15" /></td>
        </tr>
        <tr style="float:left;">
            <td>{$MOD.LBL_COLOUR_ADMIN_MENUFONT}</td><td><input type="text" id="colourselector_navbarfont" name="colourselector_navbarfont" class="color" value="{$config.colourselector.navbarfont}" size="15" /></td>
            <td>{$MOD.LBL_COLOUR_ADMIN_MENULNKHVR}</td><td><input type="text" id="colourselector_navbarlinkhover" name="colourselector_navbarlinkhover" class="color" value="{$config.colourselector.navbarlinkhover}" size="15" /></td>
        </tr>
    </table>
